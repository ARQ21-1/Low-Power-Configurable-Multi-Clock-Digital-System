...
# Created by write_sdc on Fri Aug 16 03:20:06 2024
...
create_clock [get_ports REF_CLK]  -name MASTER_CLK  -period 20  -waveform {0 10}
set_clock_uncertainty -setup 0.2  [get_clocks MASTER_CLK]
set_clock_uncertainty -hold 0.1  [get_clocks MASTER_CLK]
create_clock [get_ports UART_CLK]  -name U_CLK  -period 271.267  -waveform {0 135.634}
set_clock_uncertainty -setup 0.2  [get_clocks U_CLK]
set_clock_uncertainty -hold 0.1  [get_clocks U_CLK]
create_generated_clock [get_pins U0_CLK_GATE/GATED_CLK]  -name ALU_CLK  -source [get_ports REF_CLK]  -master_clock MASTER_CLK  -divide_by 1  -add
set_clock_uncertainty -setup 0.2  [get_clocks ALU_CLK]
set_clock_uncertainty -hold 0.1  [get_clocks ALU_CLK]
create_generated_clock [get_pins U1_ClkDiv/o_div_clk]  -name UART_RX_CLK  -source [get_ports UART_CLK]  -master_clock U_CLK  -divide_by 1  -add
create_generated_clock [get_pins U0_ClkDiv/o_div_clk]  -name UART_TX_CLK  -source [get_ports UART_CLK]  -master_clock U_CLK  -divide_by 32  -add
create_clock [get_ports scan_clk]  -name DFTCLK  -period 15000  -waveform {0 7500}
...
set_input_delay -clock DFTCLK  3000  [get_ports test_mode]
set_input_delay -clock DFTCLK  3000  [get_ports SE]
set_input_delay -clock DFTCLK  3000  [get_ports {SI[3]}]
set_input_delay -clock DFTCLK  3000  [get_ports {SI[2]}]
set_input_delay -clock DFTCLK  3000  [get_ports {SI[1]}]
set_input_delay -clock DFTCLK  3000  [get_ports {SI[0]}]
set_input_delay -clock UART_RX_CLK  54.2535  [get_ports UART_RX_IN]
set_output_delay -clock DFTCLK  3000  [get_ports {SO[3]}]
set_output_delay -clock DFTCLK  3000  [get_ports {SO[2]}]
set_output_delay -clock DFTCLK  3000  [get_ports {SO[1]}]
set_output_delay -clock DFTCLK  3000  [get_ports {SO[0]}]
set_output_delay -clock UART_TX_CLK  1736.11  [get_ports UART_TX_O]
set_output_delay -clock UART_RX_CLK  54.2535  [get_ports parity_error]
set_output_delay -clock UART_RX_CLK  54.2535  [get_ports framing_error]
set_clock_groups -asynchronous -name MASTER_CLK_1 -group [list [get_clocks MASTER_CLK] [get_clocks ALU_CLK]] -group [list [get_clocks U_CLK] [get_clocks UART_RX_CLK] [get_clocks UART_TX_CLK]] -group [get_clocks DFTCLK]
