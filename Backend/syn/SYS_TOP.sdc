...
# Created by write_sdc on Fri Aug 16 03:14:57 2024
...
set_clock_groups -asynchronous -name MASTER_CLK_1 -group [list [get_clocks MASTER_CLK] [get_clocks ALU_CLK]] -group [list [get_clocks U_CLK] [get_clocks UART_RX_CLK] [get_clocks UART_TX_CLK]]
